...
pub fn fg_muted() -> Color {
    CURRENT_THEME.read().unwrap().fg_muted
}
pub fn accent() -> Color {
    CURRENT_THEME.read().unwrap().accent
}
pub fn accent2() -> Color {
    CURRENT_THEME.read().unwrap().accent2
}
pub fn title_fg() -> Color {
    CURRENT_THEME.read().unwrap().title_fg
}
pub fn border() -> Color {
    CURRENT_THEME.read().unwrap().border
}
pub fn header_bg() -> Color {
    CURRENT_THEME.read().unwrap().header_bg
}
pub fn footer_bg() -> Color {
    CURRENT_THEME.read().unwrap().footer_bg
}
pub fn selected_bg() -> Color {
    CURRENT_THEME.read().unwrap().selected_bg
}
pub fn selected_fg() -> Color {
    CURRENT_THEME.read().unwrap().selected_fg
}
